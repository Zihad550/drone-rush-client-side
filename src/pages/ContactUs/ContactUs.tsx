  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                We're here to help! Reach out for support, partnership, or just
                to say hello. Our team is ready to assist you with any questions
        ...
        <Container
          maxWidth="lg"
          sx={{ pb: 8, position: 'relative', zIndex: 1 }}
        >
          ...
          >
            <Box sx={{ mt: 10, mb: 8, textAlign: 'center' }}>
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                ...
                >
                  Our dedicated team is here to provide you with the best
